...
function initializeMembershipCalculator() {
            ...
            <div class="calculator__row">
                <div class="calculator__option">
                    ...
                    <select id="membershipType">
                        <option value="weights">Weights Only (No Cardio)</option>
                        <option value="full">Complete Access (Weights + Cardio)</option>
                    </select>
                </div>
            ...
            <div class="calculator__row">
                <div class="calculator__option">
                    ...
                    <select id="personalTraining">
                        ...
                        <option value="1500">1 Session/month (₹1,500)</option>
                        <option value="2800">2 Sessions/month (₹2,800)</option>
                        <option value="5000">4 Sessions/month (₹5,000)</option>
                    </select>
                </div>
            ...
            <div class="calculator__result">
                <div class="result__card">
                    <div class="result__left">
                        <h3>Your Membership Cost</h3>
                        <p>Customize options to see your pricing</p>
                    </div>
                    <div class="result__right">
                        <h2 id="monthlyPrice">₹599</h2>
                        <p id="totalPrice">Total: ₹599</p>
                    </div>
                </div>
    ...
    function updatePrice() {
        ...
        // Base prices according to your data
        const prices = {
            weights: {
                1: 599,
                3: 1399,
        ...
        // Get base price for selected membership type and duration
        const basePrice = prices[membershipType][duration];
        
        // Calculate total price
        let totalPrice = basePrice;
        
        // Add personal training for the entire duration
        totalPrice += personalTraining * duration;
        
        // Add nutrition plan if selected
        if (nutritionPlan) {
            totalPrice += 999 * duration;
        }
        
        // Calculate monthly equivalent (for display purposes)
        const monthlyEquivalent = totalPrice / duration;
        
        // Update display with thousand separators
        document.getElementById('monthlyPrice').textContent = `₹${monthlyEquivalent.toLocaleString('en-IN')}`;
        document.getElementById('totalPrice').textContent = `Total: ₹${totalPrice.toLocaleString('en-IN')} for ${duration} month${duration > 1 ? 's' : ''}`;
